...
typedef SWIFT_ENUM_NAMED(NSInteger, MBDrivingSide, "DrivingSide") {
...
/// :nodoc:
/// Initialize A <code>VisualInstructionComponent</code>.
- (nonnull instancetype)initWithType:(enum MBVisualInstructionComponentType)type text:(NSString * _Nullable)text imageURL:(NSURL * _Nullable)imageURL maneuverType:(enum MBManeuverType)maneuverType maneuverDirection:(enum MBManeuverDirection)maneuverDirection OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL supportsSecureCoding;)
+ (BOOL)supportsSecureCoding SWIFT_WARN_UNUSED_RESULT;
+ (void)setSupportsSecureCoding:(BOOL)value;
...
/// The component bears an exit number or the name of a place or street.
  MBVisualInstructionComponentTypeDestination = 1,
};
