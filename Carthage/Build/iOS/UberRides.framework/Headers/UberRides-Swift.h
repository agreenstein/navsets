...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, CallbackURIType, closed) {
...
typedef SWIFT_ENUM(NSInteger, RequestButtonColorStyle, closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, RidesAuthenticationErrorType, closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, RidesScopeType, closed) {
...
@property (nonatomic, readonly, copy) NSString * _Nonnull UUID SWIFT_DEPRECATED_MSG("use riderID instead");
