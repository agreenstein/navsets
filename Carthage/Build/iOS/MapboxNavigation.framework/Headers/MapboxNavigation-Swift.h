...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL isConnected;)
+ (BOOL)isConnected SWIFT_WARN_UNUSED_RESULT;
+ (void)setIsConnected:(BOOL)value;
/// The events manager used during turn-by-turn navigation while connected to
/// CarPlay.
@property (nonatomic, readonly, strong) MBNavigationEventsManager * _Nonnull eventsManager;
...
/// interface.
/// \param styles The styles to display in the CarPlay interface. If this
/// argument is omitted, <code>DayStyle</code> and <code>NightStyle</code> are displayed by
/// default.
///
/// \param directions The object that calculates routes when the user
/// interacts with the CarPlay interface. If this argument is <code>nil</code> or
/// omitted, the shared <code>Directions</code> object is used by default.
///
/// \param eventsManager The events manager to use during turn-by-turn
/// navigation while connected to CarPlay. If this argument is <code>nil</code> or
/// omitted, a standard <code>NavigationEventsManager</code> object is used by default.
///
- (nonnull instancetype)initWithStyles:(NSArray<MBStyle *> * _Nullable)styles directions:(MBDirections * _Nullable)directions eventsManager:(MBNavigationEventsManager * _Nullable)eventsManager OBJC_DESIGNATED_INITIALIZER;
...
///
/// returns:
/// A navigation service that manages location updates along <code>route</code>.
- (id <MBNavigationService> _Nonnull)carPlayManager:(MBCarPlayManager * _Nonnull)carPlayManager navigationServiceAlongRoute:(MBRoute * _Nonnull)route SWIFT_WARN_UNUSED_RESULT;
...
/// \param carPlayManager The shared CarPlay manager.
///
/// \param service The navigation service that has begun managing location updates for a navigation session.
///
- (void)carPlayManager:(MBCarPlayManager * _Nonnull)carPlayManager didBeginNavigationWithNavigationService:(id <MBNavigationService> _Nonnull)service;
...
@interface MBCarPlayNavigationViewController : UIViewController
...
/// These are the styles available to the view controller’s internal <code>StyleManager</code> object. In CarPlay, <code>Style</code> objects primarily affect the appearance of the map, not guidance-related overlay views.
@property (nonatomic, copy) NSArray<MBStyle *> * _Nonnull styles;
...
/// \param navigationService The navigation service managing location updates for the navigation session.
///
...
///
/// \param manager The manager for CarPlay.
///
/// \param styles The interface styles that the view controller’s internal <code>StyleManager</code> object can select from for display.
///
- (nonnull instancetype)initWithNavigationService:(id <MBNavigationService> _Nonnull)navigationService mapTemplate:(CPMapTemplate * _Nonnull)mapTemplate interfaceController:(CPInterfaceController * _Nonnull)interfaceController manager:(MBCarPlayManager * _Nonnull)manager styles:(NSArray<MBStyle *> * _Nullable)styles OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_AVAILABILITY(ios,introduced=12.0)
@interface MBCarPlayNavigationViewController (SWIFT_EXTENSION(MapboxNavigation)) <NavigationServiceDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=12.0)
@interface MBCarPlayNavigationViewController (SWIFT_EXTENSION(MapboxNavigation)) <MBNavigationMapViewDelegate>
- (CGPoint)navigationMapViewUserAnchorPoint:(MBNavigationMapView * _Nonnull)mapView SWIFT_WARN_UNUSED_RESULT;
@end
...
/// Initialize a new FeedbackViewController from a <code>NavigationEventsManager</code>.
- (nonnull instancetype)initWithEventsManager:(MBNavigationEventsManager * _Nonnull)eventsManager OBJC_DESIGNATED_INITIALIZER;
...
@interface MBFeedbackViewController (SWIFT_EXTENSION(MapboxNavigation)) <UICollectionViewDelegateFlowLayout>
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface MBFeedbackViewController (SWIFT_EXTENSION(MapboxNavigation)) <UICollectionViewDelegate>
...
@interface MBFeedbackViewController (SWIFT_EXTENSION(MapboxNavigation)) <UIViewControllerTransitioningDelegate>
...
@interface MBFeedbackViewController (SWIFT_EXTENSION(MapboxNavigation)) <UICollectionViewDataSource>
...
SWIFT_PROTOCOL("_TtP16MapboxNavigation30FeedbackViewControllerDelegate_")
@protocol FeedbackViewControllerDelegate
@optional
/// Called when the user opens the feedback form.
- (void)feedbackViewControllerDidOpen:(MBFeedbackViewController * _Nonnull)feedbackViewController;
/// Called when the user submits a feedback event.
- (void)feedbackViewController:(MBFeedbackViewController * _Nonnull)feedbackViewController didSendFeedbackItem:(MBFeedbackItem * _Nonnull)feedbackItem UUID:(NSUUID * _Nonnull)uuid;
/// Called when a <code>FeedbackViewController</code> is dismissed for any reason without giving explicit feedback.
- (void)feedbackViewControllerDidCancel:(MBFeedbackViewController * _Nonnull)feedbackViewController;
@end
...
- (void)didDragInstructionsBanner:(BaseInstructionsBannerView * _Nonnull)sender SWIFT_DEPRECATED_MSG("Please use didSwipeInstructionsBanner instead.");
/// Called when the user swipes either left, right, or down on the <code>InstructionsBannerView</code>
- (void)didSwipeInstructionsBanner:(BaseInstructionsBannerView * _Nonnull)sender swipeDirection:(UISwipeGestureRecognizerDirection)direction;
@end
...
@interface MGLAccountManager (SWIFT_EXTENSION(MapboxNavigation))
...
/// This property takes effect when the application has limited resources for animation, such as when the device is running on battery power. By default, this property is set to <code>MGLMapViewPreferredFramesPerSecond.lowPower</code>.
//@property (nonatomic) MGLMapViewPreferredFramesPerSecond minimumFramesPerSecond;
...
/// This method accounts for the proximity to a maneuver and the current power source. It has no effect if <code>tracksUserCourse</code> is set to <code>true</code>.
...
/// See <code>NavigationService</code> for more information.
@property (nonatomic, strong) id <MBNavigationService> _Null_unspecified navigationService;
...
/// \param route The route to navigate along.
///
/// \param styles The styles that the view controller’s internal <code>StyleManager</code> object can select from for display.
///
/// \param navigationService The navigation service that manages navigation along the route.
///
/// \param voiceController The voice controller that manages the delivery of voice instructions during navigation.
///
- (nonnull instancetype)initWithRoute:(MBRoute * _Nonnull)route styles:(NSArray<MBStyle *> * _Nullable)styles navigationService:(id <MBNavigationService> _Nullable)navigationService voiceController:(MBRouteVoiceController * _Nullable)voiceController OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
...
@interface MBNavigationViewController (SWIFT_EXTENSION(MapboxNavigation)) <NavigationServiceDelegate>
...
- (void)navigationService:(id <MBNavigationService> _Nonnull)service didRerouteAlongRoute:(MBRoute * _Nonnull)route at:(CLLocation * _Nullable)at proactive:(BOOL)proactive;
...
/// The <code>VisualInstructionDelegate</code> protocol defines a method that allows an object to customize presented visual instructions.
...
/// \param navigationViewController The Navigation VC that is detecting the users’ approach.
///
...
///
- (void)navigationViewController:(MBNavigationViewController * _Nonnull)navigationViewController willArriveAtWaypoint:(MBWaypoint * _Nonnull)waypoint after:(NSTimeInterval)remainingTimeInterval distance:(CLLocationDistance)distance;
...
/// postcondition:
/// If you return <code>false</code> within this method, you must manually advance to the next leg: obtain the value of the <code>navigationService</code> and its <code>NavigationService.routeProgress</code> property, then increment the <code>RouteProgress.legIndex</code> property.
...
/// \param location The user’s current location.
///
- (void)navigationViewController:(MBNavigationViewController * _Nonnull)navigationViewController willRerouteFromLocation:(CLLocation * _Nullable)location;
