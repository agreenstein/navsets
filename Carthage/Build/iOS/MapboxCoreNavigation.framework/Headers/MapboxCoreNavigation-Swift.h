...
- (nonnull instancetype)initWithRoute:(MBRoute * _Nonnull)route directions:(MBDirections * _Nonnull)directions locationManager:(id <MBRouterDataSource> _Nonnull)source;
@property (nonatomic, readonly, strong) MBRouteProgress * _Nonnull routeProgress;
@property (nonatomic, strong) MBRoute * _Nonnull route;
...
///
- (nonnull instancetype)initWithRoute:(MBRoute * _Nonnull)route directions:(MBDirections * _Nonnull)directions locationManager:(id <MBRouterDataSource> _Nonnull)source OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS_NAMED("PortableRouteController")
@interface MBPortableRouteController : MBRouteController
@property (nonatomic, strong) MBRoute * _Nonnull route;
- (nonnull instancetype)initWithRoute:(MBRoute * _Nonnull)route directions:(MBDirections * _Nonnull)directions locationManager:(id <MBRouterDataSource> _Nonnull)source OBJC_DESIGNATED_INITIALIZER;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
...
@interface MBRouteController (SWIFT_EXTENSION(MapboxCoreNavigation))
- (nonnull instancetype)initWithRoute:(MBRoute * _Nonnull)route directions:(MBDirections * _Nonnull)directions locationManager:(MBNavigationLocationManager * _Nonnull)locationManager eventsManager:(MBNavigationEventsManager * _Nonnull)eventsManager;
